...
.modal-content{background:rgba(255,255,255,0.1); padding:2rem; border-radius:1rem; width:90%; max-width:400px; backdrop-filter:blur(10px); text-align:center;}
.close-btn{float:right; font-size:1.5rem; cursor:pointer; color:#FFD166;}

#contact .socials{display:flex; justify-content:center; gap:1.5rem; margin-top:1.5rem;}
#contact .socials a{color:#FFD166; font-size:1.5rem; transition:0.3s;}
#contact .socials a:hover{color:#F6AE2D; transform:scale(1.2);}
...
<footer>© 2025 SwiftParcel | Designed with 💙 by You</footer>
...
e.preventDefault();
const btn=document.getElementById('contactForm').querySelector('button');
btn.classList.add('success');
btn.textContent='Sent ✓';
document.getElementById('chime').play();
setTimeout(()=>{btn.classList.remove('success');btn.textContent='Send Message';document.getElementById('contactForm').reset();},1200);
});
